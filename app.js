...
var tableElm = document.createElement("table");
tableElm.setAttribute("border", "1");
var subjects = ["Subject 1", "Subject 2", "Subject 3", "Subject 4", "Subject 5"];
var marks = [sub1, sub2, sub3, sub4, sub5];

for (let i = 0; i < subjects.length; i++) {
    var tableRow = document.createElement("tr");

    var subjectCell = document.createElement(i === 0 ? "th" : "td");
    subjectCell.innerText = i === 0 ? "Subject" : subjects[i];
    tableRow.appendChild(subjectCell);
    
    var marksCell = document.createElement(i === 0 ? "th" : "td");
    marksCell.innerText = i === 0 ? "Marks" : marks[i];
    tableRow.appendChild(marksCell);
...
tableElm.classList.add("tableElm");